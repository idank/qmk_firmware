...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT(
    ...
    KC_LCTL  , LCA(KC_DEL) , KC_LWIN , KC_LALT , LT(2,KC_SPC), LT(3,KC_TAB) , QK_KB_7 ,        LT(4,KC_ENT), LT(5,KC_BSPC),                                 TG(1)    , KC_INS
  ),
  ...
  [1] = LAYOUT(
    ...
    XXXXXXX  , XXXXXXX , XXXXXXX , XXXXXXX , XXXXXXX , XXXXXXX , XXXXXXX ,               XXXXXXX , QK_KB_6   , KC_HOME    , KC_PGDN    , KC_PGUP    , KC_END     , QK_KB_15 ,
    _______  , _______ , _______ , _______ , _______ , _______ , _______ ,               _______ , _______   ,                                        _______    , _______
  ),

  // L NAVIGATION & SCREENSHOT, R 10 KEY
  [2] = LAYOUT(
    _______  , _______    , _______  , _______  , _______  , _______  ,                                     KC_PEQL  , KC_P7    , KC_P8    , KC_P9    , KC_PSLS  , _______  ,
    INSPE    , XXXXXXX    , XXXXXXX  , KC_UP    , XXXXXXX  , XXXXXXX  ,                                     KC_PAST  , KC_P4    , KC_P5    , KC_P6    , KC_PPLS  , _______  ,
    INSPP    , LSG(KC_S)  , KC_LEFT  , KC_DOWN  , KC_RIGHT , XXXXXXX  ,                                     KC_PCMM  , KC_P1    , KC_P2    , KC_P3    , KC_PMNS  , _______  ,
    PFX      , XXXXXXX    , XXXXXXX  , XXXXXXX  , XXXXXXX  , XXXXXXX  , A(KC_F4)    ,            _______  , KC_P0    , KC_P0    , XXXXXXX  , KC_DOT   , KC_PENT  , _______  ,
    _______  , _______    , _______  , _______  , _______  , _______  , _______     ,            _______  , _______  ,                                  _______  , _______
  ),
