...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [0] = LAYOUT(
    ...
    KC_LCTL  , LCA(KC_DEL)   , KC_LWIN  , KC_LALT  , QK_KB_7  , LT(2,KC_SPC) , LT(3,KC_TAB) ,        LT(4,KC_ENT), LT(5,KC_BSPC),                                 TG(1)    , KC_INS
  ),
  ...
  [1] = LAYOUT(
    ...
    XXXXXXX  , XXXXXXX , XXXXXXX , XXXXXXX , XXXXXXX , XXXXXXX , XXXXXXX ,               QK_KB_10, QK_KB_6   , KC_HOME    , KC_PGDN    , KC_PGUP    , KC_END     , QK_KB_15 ,
  ...
  [2] = LAYOUT(
    ...
    PFX      , XXXXXXX    , XXXXXXX  , XXXXXXX  , XXXXXXX  , XXXXXXX  , A(KC_F4)    ,            _______  , KC_PEQL  , KC_P0    , KC_P0    , KC_DOT   , KC_PENT  , _______  ,
    _______  , _______    , _______  , _______  , _______  , _______  , _______     ,            _______  , _______  ,                                  _______  , _______
  ),
